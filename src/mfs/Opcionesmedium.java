 ...
 * @author 102976781
 */
public class Opcionesmedium extends javax.swing.JFrame {

    
    public Dificult dificultad = new Dificult();
    
    public Opcionesmedium() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Opcionesmedium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Opcionesmedium().setVisible(true);
            }
        });
    }
